...
bool Command::function_Case(CommandNode *c, ReturnValue &rv)
{
...
bool Command::function_Default(CommandNode *c, ReturnValue &rv)
{
	return TRUE;
}
...
// Quit program
bool Command::function_Quit(CommandNode *c, ReturnValue &rv)
{
...
// Switch statement
bool Command::function_Switch(CommandNode *c, ReturnValue &rv)
{
