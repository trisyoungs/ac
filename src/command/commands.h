...
class Command
{
	...
	*/
	...
	static bool function_Case(CommandNode *c, ReturnValue &rv);
	static bool function_Continue(CommandNode *c, ReturnValue &rv);
	static bool function_Default(CommandNode *c, ReturnValue &rv);
	...
	static bool function_Quit(CommandNode *c, ReturnValue &rv);
	static bool function_Return(CommandNode *c, ReturnValue &rv);
	static bool function_Switch(CommandNode *c, ReturnValue &rv);
