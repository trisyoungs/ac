...
// Constructor
IntegerVariable::IntegerVariable(signed long int i, bool constant) : integerData_(i)
{
	// Private variables
...
signed long int *IntegerArrayVariable::arrayData()
{
...
bool IntegerArrayVariable::initialise()
{
	...
	if ((arraySize_ > 0) && (integerArrayData_ == NULL)) integerArrayData_ = new signed long int[arraySize_];
